...
public abstract class Shape {
	 ...
	 * is called on. If the called object is not a child within a
	 * CarrierShape instance this method returns null .
	 *
	 */
	public CarrierShape parent() {
		if (_parent instanceof spaceshapes.CarrierShape) {
			return _parent;
		}else {
			return null;
		}
	...
	public List<Shape> path(){
		Shape k = this;
		_path.add(k);
		while(k._parent!=null) {
			_path.add(0, k._parent);
			k = k._parent;
		}
		return _path;
	}
	...
	/**
	 * Associate a text to a shape object.
	 * @param text The text wanted to be added.
	 */
	...
	/**
	 * Display the text associated with the object.
	 * @param painter
	 */
	public void displayText(Painter painter) {
		painter.translate(_x, _y);
		if(Text!=null) {
			painter.drawCentredText(Text, (_width), (_height));
		}
		painter.translate(-_x,-_y);
	}
}
